      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between">
          <NavLink to="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 rounded-md gradient-primary flex items-center justify-center shadow-lg shadow-primary/30 group-hover:rotate-12 transition-transform duration-300">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <div className="flex items-center gap-4 border-l-2 border-border pl-8">
              ...
              <NavLink to="/register">
                <Button
                  size="sm"
                  className="rounded-md px-6 gradient-primary font-bold shadow-md hover:shadow-primary/30"
                >
          ...
          {/* Mobile toggle */}
          <button
            className="md:hidden w-10 h-10 flex items-center justify-center rounded-md bg-muted text-foreground border-2 border-border shadow-sm"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="pt-4 flex flex-col gap-3">
                <NavLink to="/login" onClick={() => setIsOpen(false)}>
                  <Button
                    variant="outline"
                    className="w-full h-12 rounded-md font-bold border-2"
                  >
                    Iniciar Sesión
                  </Button>
                </NavLink>
                <NavLink to="/register" onClick={() => setIsOpen(false)}>
                  <Button className="w-full h-12 rounded-md gradient-primary font-bold">
